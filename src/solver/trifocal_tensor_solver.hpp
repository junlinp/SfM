...
struct TriPair {
    ...
    TriPair(const Eigen::Vector3d& lhs, const Eigen::Vector3d& middle,const Eigen::Vector3d& rhs) : lhs(lhs), middle(middle), rhs(rhs) {}
    TriPair(const Eigen::Vector2d& lhs, const Eigen::Vector2d& middle,const Eigen::Vector2d& rhs) : lhs(lhs.homogeneous()), middle(middle.homogeneous()), rhs(rhs.homogeneous()) {}
};
